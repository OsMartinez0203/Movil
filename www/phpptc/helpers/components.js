...
// grafico lineal
function grafiLinea(canvas, xAxis, yAxis, legend, title)
{
    let colors = [];
    for (i = 0; i < xAxis.length; i++) {
        colors.push('#' + (Math.random().toString(16)).substring(2, 8));
...
function donaGraph(canvas, marca, cantidad, title){
    var color = ['rgba(255, 206, 86, 02)', 'rgba(255, 99, 132, 0.2)']
    var border = ['rgba(225, 206, 86, 10)', 'rgba(255, 99, 132, 1)']
    const context = $('#' + canvas);
    var dona = new Chart(context, {
        type: 'doughnut',
        data: data = {
            datasets: [{
                data: [cantidad]
...
function donaGraph2(canvas, marca, cantidad, title){
    var color = ['rgba(255, 206, 86, 02)', 'rgba(255, 99, 132, 0.2)']
    var border = ['rgba(225, 206, 86, 10)', 'rgba(255, 99, 132, 1)']
    const context = $('#' + canvas);
    var dona = new Chart(context, {
